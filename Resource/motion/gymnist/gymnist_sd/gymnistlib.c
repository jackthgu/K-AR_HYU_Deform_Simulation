...
#define lasterr (gymnistgerror.lasterr_)
#define lastrou (gymnistgerror.lastrou_)

gymnistgerror_t gymnistgerror = {
/* Error parameters
*/
    /* lasterr */ 0,
    /* lastrou */ 0,
...
void gymnistprerrmsg(FILE *fnum,
    int routine,
    int errnum)
{
    ...
    fprintf(fnum,"\n");
    if (routine == 1) {
        fprintf(fnum,"gymnistgrav:\n");
    }
    if (routine == 2) {
        fprintf(fnum,"gymnistmass:\n");
    }
    if (routine == 3) {
        fprintf(fnum,"gymnistiner:\n");
    }
    if (routine == 4) {
        fprintf(fnum,"gymnistbtj:\n");
    }
    if (routine == 5) {
        fprintf(fnum,"gymnistitj:\n");
    }
    if (routine == 6) {
        fprintf(fnum,"gymnistpin:\n");
    }
    if (routine == 7) {
        fprintf(fnum,"gymnistinit:\n");
    }
    if (routine == 8) {
        fprintf(fnum,"gymniststate:\n");
    }
    if (routine == 9) {
        fprintf(fnum,"gymnistpsstate:\n");
    }
    if (routine == 13) {
        fprintf(fnum,"gymnistpresacc:\n");
    }
    if (routine == 14) {
        fprintf(fnum,"gymnistpresvel:\n");
    }
    if (routine == 15) {
        fprintf(fnum,"gymnistprespos:\n");
    }
    if (routine == 10) {
        fprintf(fnum,"gymnisthinget:\n");
    }
    if (routine == 11) {
        fprintf(fnum,"gymnistpointf:\n");
    }
    if (routine == 12) {
        fprintf(fnum,"gymnistbodyt:\n");
    }
    if (routine == 17) {
        fprintf(fnum,"gymnistderiv:\n");
    }
    if (routine == 16) {
        fprintf(fnum,"gymnistresid:\n");
    }
    if (routine == 18) {
        fprintf(fnum,"gymnistpseudo:\n");
    }
    if (routine == 19) {
        fprintf(fnum,"gymnistmom:\n");
    }
    if (routine == 20) {
        fprintf(fnum,"gymnistsys:\n");
    }
    if (routine == 21) {
        fprintf(fnum,"gymnistpos:\n");
    }
    if (routine == 22) {
        fprintf(fnum,"gymnistvel:\n");
    }
    if (routine == 23) {
        fprintf(fnum,"gymnistorient:\n");
    }
    if (routine == 24) {
        fprintf(fnum,"gymnistangvel:\n");
    }
    if (routine == 25) {
        fprintf(fnum,"gymnisttrans:\n");
    }
    if (routine == 26) {
        fprintf(fnum,"gymnistperr:\n");
    }
    if (routine == 27) {
        fprintf(fnum,"gymnistverr:\n");
    }
    if (routine == 28) {
        fprintf(fnum,"gymnistpsqdot:\n");
    }
    if (routine == 29) {
        fprintf(fnum,"gymnistpsudot:\n");
    }
    if (routine == 30) {
        fprintf(fnum,"gymnistgetht:\n");
    }
    if (routine == 31) {
        fprintf(fnum,"gymnistreac:\n");
    }
    if (routine == 32) {
        fprintf(fnum,"gymnistacc:\n");
    }
    if (routine == 33) {
        fprintf(fnum,"gymnistangacc:\n");
    }
    if (routine == 34) {
        fprintf(fnum,"gymnistmult:\n");
    }
    if (routine == 35) {
        fprintf(fnum,"gymnistaerr:\n");
    }
    if (routine == 36) {
        fprintf(fnum,"gymnistindx:\n");
    }
    if (routine == 37) {
        fprintf(fnum,"gymnistpres:\n");
    }
    if (routine == 38) {
        fprintf(fnum,"gymniststab:\n");
    }
    if (routine == 39) {
        fprintf(fnum,"gymnistgetgrav:\n");
    }
    if (routine == 40) {
        fprintf(fnum,"gymnistgetmass:\n");
    }
    if (routine == 41) {
        fprintf(fnum,"gymnistgetiner:\n");
    }
    if (routine == 42) {
        fprintf(fnum,"gymnistgetbtj:\n");
    }
    if (routine == 43) {
        fprintf(fnum,"gymnistgetitj:\n");
    }
    if (routine == 44) {
        fprintf(fnum,"gymnistgetpin:\n");
    }
    if (routine == 45) {
        fprintf(fnum,"gymnistgetpres:\n");
    }
    if (routine == 46) {
        fprintf(fnum,"gymnistgetstab:\n");
    }
    if (routine == 47) {
        fprintf(fnum,"gymnistinfo:\n");
    }
    if (routine == 48) {
        fprintf(fnum,"gymnistjnt:\n");
    }
    if (routine == 49) {
        fprintf(fnum,"gymnistcons:\n");
    }
    if (routine == 50) {
        fprintf(fnum,"gymnistassemble:\n");
    }
    if (routine == 51) {
        fprintf(fnum,"gymnistinitvel:\n");
    }
    if (routine == 52) {
        fprintf(fnum,"gymniststatic:\n");
    }
    if (routine == 53) {
        fprintf(fnum,"gymniststeady:\n");
    }
    if (routine == 54) {
        fprintf(fnum,"gymnistmotion:\n");
    }
    if (routine == 55) {
        fprintf(fnum,"gymnistfmotion:\n");
    }
    if (routine == 56) {
        fprintf(fnum,"gymnistequivht:\n");
    }
    if (routine == 57) {
        fprintf(fnum,"gymnistmassmat:\n");
    }
    if (routine == 58) {
        fprintf(fnum,"gymnistfrcmat:\n");
    }
    if (routine == 59) {
        fprintf(fnum,"gymnistrel2cart:\n");
    }
    if (routine == 60) {
        fprintf(fnum,"gymnistcomptrq:\n");
    }
    if (routine == 61) {
        fprintf(fnum,"gymnistfulltrq:\n");
    }
    if (routine == 62) {
        fprintf(fnum,"gymnistvrot:\n");
    }
    if (errnum == 1) {
    ...
    if (errnum == 22) {
        fprintf(fnum,"gymnistinit must be called first\n");
    }
    if (errnum == 23) {
        fprintf(fnum,"gymniststate must be called first\n");
    }
    if (errnum == 24) {
        fprintf(fnum,"gymnistderiv must be called first\n");
    }
    if (errnum == 25) {
...
void gymnistprinterr(FILE *fnum)
{

    gymnistprerrmsg(fnum,lastrou,lasterr);
}

void gymnistclearerr(void)
{
...
void gymnistseterr(int routine,
    int errnum)
{
    ...
    double x[])
{
    ...
    gymnistldubsl(n,na,map,l,b,work);
    gymnistldubsd(n,na,map,d,work,work);
    gymnistldubsu(n,na,map,l,work,x);
}

void gymnistlduslv(int n,
    int na,
    int map[],
    double tol,
    double work1[],
    ...
    double x[])
{
    ...
    gymnistldudcomp(n,na,map,tol,work1,work2,m,l,d);
    gymnistldubslv(n,na,map,work2,l,d,b,x);
}
    ...
    int *rank)
{
    ...
    if (k  !=  0) {
        gymnistqrsl(nr,nc,nra,nca,mapr,mapc,k,work,w,qraux,b,x);
    }
    for (j = k; j <= nca-1; j++) {
        x[mapc[j]] = 0.;
    }
    ...
    int *rank)
{
    ...
    gymnistqrdcomp(nr,nc,nra,nca,mapr,mapc,w,qraux,jpvt);
    gymnistqrbslv(nr,nc,nra,nca,mapr,mapc,tol,work,iwork,w,qraux,jpvt,b,x,rank);
}
    ...
    double x[])
{
    ...
    if (ndes  ==  0) {
        ...
        gymnistqrslv(nra,nra,nra,nra,&iw[map],&iw[map],tol,&iw[jpvt],&rw[qraux],
        ...
        gymnistqrslv(dsiz,dsiz,dsiz,dsiz,&iw[map],&iw[map],tol,&iw[jpvt],&rw[
...
/* Utility routines for use with gymnistroot. */


void gymnistcalcerrs(double fval[],
    int nfunc,
    int ndes,
    int dnorm,
    double *maxderr,
    ...
    double newerrs[])
{
    ...
    *fcnt = *fcnt+1;
    ...
    gymnistcalcerrs(newerrs,nfunc,ndes,dnorm,&maxderr,&maxrerr,&derrnorm);
    ...
    int *err)
{
    ...
    *fcnt = *fcnt+1;
    gymnistcalcerrs(fret,nfunc,ndes,dnorm,&pmaxderr,&pmaxrerr,&pderrnorm);
    crude = 1e-6;
    for (ntrys = 0; ntrys < 2; ntrys++) {
        ...
        for (;;) {
            ...
            gymnistcalcjac(func,vars,param,nfunc,nvar,lock,crude,fret,&rw[f1]
              ,jw,fcnt,&rw[scale]);
            for (i = 0; i < nfunc; i++) {
                rw[f1+i] = fret[i]*rw[scale+i];
            }
            gymnistlsslv(nfunc,nvar,nfunc,nvar,ndes,&iw[mapf],&iw[mapv]
              ,qrtol,dw,&rw[morerw],&iw[moreiw],jw,&rw[f1],&rw[deltav]);
            for (;;) {
                gymnistadjvars(func,vars,param,nfunc,ndes,dnorm,nvar,&rw[deltav]
                  ,step,pmaxrerr,pderrnorm,rtol,fcnt,&rw[guess],&rw[f1]);
                gymnistcalcerrs(&rw[f1],nfunc,ndes,dnorm,&maxderr,&maxrerr,&
                  derrnorm);
...
/* Utility routine for use with gymnistfinteg and gymnistvinteg.  Work is 2*neq. */


void gymnistrk4m(int (*func)(),
    double time,
    double st[],
    double dst0[],
    double param[],
...
//#define USE_EULER
#ifdef USE_EULER
    gymniststate(*time,st,&st[55]);
    gymnistuforce(*time,st,&st[55]);
    gymnistderiv(dst,&dst[55]);

	printf("%d\n", neq);
    //for (i = 0; i < neq; i++) {
    //    st[i] = st[i]+dst[i]*step;
    //}
    for (i = 0; i < neq; i++) {
		st[i] = dst[i];
	}
...
#else
    if (step > 0.) {
        gymnistrk4m(func,ttime,st,dst,param,step,&work[nst],neq,&work[morework],
    ...
    int *which)
{
    ...
    *err = 0;
    ...
    while (ttime  <  tfin) {
        ...
        nstp = stp;
        for (;;) {
            gymnistrk4m(func,ttime,st,dst,param,nstp,&work[xst],neq,&work[
            ...
            if (stp2 < minstep) {
                ...
                gymnistrk4m(func,xtime,&work[xst],&work[xdst],param,stp2,&work[
...
void gymnistdc2ang(double dircos[3][3],
    double *a1,
    double *a2,
    double *a3)
{
...
void gymnistdc2quat(double dircos[3][3],
    double *e1,
    double *e2,
    double *e3,
    double *e4)
...
void gymnistquat2dc(double ie1,
    double ie2,
    double ie3,
    double ie4,
    double dircos[3][3])
...
double 
gymnistvnorm(double ivec[3])
{
    double norm;

/* Compute the length (norm) of a vector
*/
    norm = sqrt(gymnistvdot(ivec,ivec));
    return norm;
}

void gymnistvcopy(double ivec[3],
    double ovec[3])
{
...
void gymnistvadd(double ivec1[3],
    double ivec2[3],
    double ovec[3])
{
...
void gymnistvsub(double ivec1[3],
    double ivec2[3],
    double ovec[3])
{
...
void gymnistvcross(double ivec1[3],
    double ivec2[3],
    double ovec[3])
{
    double tempout[3];
...
void gymnistvrot(double ivec[3],
    double rvec[3],
    double theta,
    double ovec[3])
{
...
*/
    ...
    stheta = sin(theta);
    ctheta = cos(theta);
    gymnistvmul(stheta,ivec,isinvec);
    gymnistvmul(ctheta,ivec,icosvec);
    norm = 1./norm;
    gymnistvmul(norm,rvec,uvec);
    idotu = gymnistvdot(ivec,uvec);
    gymnistvcross(uvec,isinvec,uxisin);
    dotcos = idotu*(1.-ctheta);
    gymnistvaxpy(dotcos,uvec,icosvec,ovec);
    gymnistvadd(ovec,uxisin,ovec);
}

void gymnistserialno(int *serno)
{

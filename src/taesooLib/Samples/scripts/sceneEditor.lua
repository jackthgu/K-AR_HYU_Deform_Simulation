materialNames:addItem({
{"Crowd materials", "Crowd/Blue", "Crowd/Red", "Crowd/Green", "Crowd/Red", "Crowd/Dirt", 
...
{"Icons", "blueCircle", "redCircle", "icons/add", "icons/refresh"}
})

meshFiles:addItem({
{"Simple polygons", "vehicle.mesh", "sphere1010.mesh", "arrow.mesh", "cone.mesh", "axes.mesh", "cylinder.mesh"},
{"Static objects", "pave.mesh", "ogrehead.mesh"},
...
{"Dynamic objects", "hyunwoo.mesh", "muaythai1.mesh", "robot.mesh"}
})

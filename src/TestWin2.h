...
class TestWin2 : public FlLayout, public INativeRender, public FrameMoveObject, public FltkRenderer::Handler {
...
public:
   ...
   TestWin2(int x, int y, int w, int h, MotionPanel &mp, FltkRenderer &renderer);

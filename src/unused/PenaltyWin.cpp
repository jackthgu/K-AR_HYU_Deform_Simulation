...
void FlexibleBodyImplicitSimplePenaltyWin::show()	
{
	m_renderer->ogreRenderer().fixedTimeStep(true); 
	ScriptBaseWin::show();
}
void FlexibleBodyImplicitSimplePenaltyWin::hide()	
{	
...
FlexibleBodyImplicitSimplePenaltyWin::FlexibleBodyImplicitSimplePenaltyWin(int x, int y, int w, int h, MotionPanel& mp,FltkRenderer& renderer)
...
void FlexibleBodyImplicitSimplePenaltyWin ::loadIguanaMotion()
{
	if(!mMotion)
	{
...
FlexibleBodyImplicitSimplePenaltyWin ::~FlexibleBodyImplicitSimplePenaltyWin (void)
{
	mSimulator.exitWorld();

	//RE::remove(mSkin);
}
void FlexibleBodyImplicitSimplePenaltyWin ::initLuaEnvironment()
{
	...
	ls.set<FlexibleBodyImplicitSimplePenaltyWin>("win", this);
}

void FlexibleBodyImplicitSimplePenaltyWin::startWorld()
{
...
{
	return new FlexibleBodyImplicitSimplePenaltyWin(x,y,w,h,mp, renderer);
}

void FlexibleBodyImplicitSimplePenaltyWin::createTargetMesh(int iframe, double scale_factor, vector3 const& initialPosition)
{
